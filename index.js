...
json = {
  "Понедельник":
  {
    "14.30–15.50": [
      ...
      foo("2н", "", "Инженерия и разр ПО", "Перез-Чернов А.Х.", "л", 606, [["https://www.twitch.tv/apereztchernov", "twitch"]])],
    "16.00–17.20": [
    ...
    "19.00-20.20": [foo("","", "КМиСО", "Ромащенко Г.С.", "л", 609, [["https://meet.jit.si/КМиИСО3к2и9гр", "meet"]])]
  },
  "Вторник": {
    "11:15–12:35": [foo("", "", "Физическая культура", "", "", "")],
    "16.00–17.20": [
      foo("1н", "", "ДС Авт тестир ПО (Купревича)", "Калуга", "л", ""),
      foo("2н", "б", "ДС Авт тестир ПО (Купревича)", "Калуга", "п", "")],
    "17.30–18.50": [foo("1н", "а", "ДС Авт тестир ПО (Купревича)", "Калуга", "", "")]
  },
  "Среда": {
  	"11.15–12.35": [foo("", "", "Физическая культура", "", "", "")],
  	...
  	"14.30–15.50": [
  		...
  		foo("1н", "б", "Комп сети", "Мухаметов", "п", 409, [["https://us02web.zoom.us/j/86481395842?pwd=WUNHZ0dlQnh..", "zoom"], "bsu-ks"]),
  		foo("2н", "а", "Комп сети", "Мухаметов", "п", 409, [["https://us02web.zoom.us/j/86481395842?pwd=WUNHZ0dlQnh..", "zoom"], "bsu-ks"]),
  		foo("2н", "б", "Инженерия и разр ПО", "Перез-Чернов", "п", 404, [["https://www.twitch.tv/apereztchernov", "twitch"]])],
    "16.00–17.20": [
    ...
    "19.00–20.20": [
    	foo("1н", "", "ДС C# (проектор)", "Кравчук", "л", 419, [["https://edummf.bsu.by/course/view.php?id=417", "edu"]]),
    	foo("2н", "а", "ДС C#", "Кравчук", "п", 409, [["https://edummf.bsu.by/course/view.php?id=417", "edu"]]),]
  },
  "Пятница": {
  	"13.00–14.20": [foo("", "", "Комп сети", "Мухаметов", "л", 606, 
  		[["https://us02web.zoom.us/j/86481395842?pwd=WUNHZ0dlQnh..", "zoom"], "bsu-ks"])], 
  	"14.30–15.50": [foo("", "", "УМФ", "Ломовцев Ф.Е.", "л", 419, [["https://edummf.bsu.by/course/view.php?id=286", "edu"]])],
    "16.00–17.20": [foo("", "", "ФАН", "Чесалин", "л", 609, [[" https://zoom.us/j/9493937295", "zoom"], "139006"])],
    "17.30–18.50": [
    	foo("", "а", "КМиСО", "Ромащенко", "п", 404, [["https://meet.jit.si/КМиИСО3к2и9гр", "meet"]]),
    	foo("2н", "б", "ДС C#", "Кравчук", "п", 409, [["https://edummf.bsu.by/course/view.php?id=417", "edu"]])],
